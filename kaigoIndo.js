...
// @version      1.0
// @description  Script Kaigo Indonesia
// @author       Aesel
...
window.onload = function() {
    ...
    // ExamSelect page
        ...
        document.querySelector('option[value="JH0-I11J"]').selected = true;
    ...
    // Status page
        ...
        document.querySelector('option[value="High school graduate"]').selected = true;
        document.querySelector('option[value="I don\'t have any work experience."]').selected = true;
        document.querySelector('option[value="No, I have not been to Japan before"]').selected = true;
        document.querySelector('option[value="less than 3 months"]').selected = true;
        document.querySelector('option[value="self study"]').selected = true;
        document.querySelector('option[value="JFT-Basic"]').selected = true;
