...
window.onload = function() {
    ...
    // ExamSelect page
        ...
        document.querySelector('option[value="NC0-I12J"]').selected = true;
...
window.addEventListener("DOMContentLoaded", (e) => {
    ...
    const days_month_list = [
        {"month": "09", "days": [2,3,4,5,6,7,9,10,11,12,13,14,17,18,19,20]},
        {"month": "08", "days": [13,14,15,19,20,23,24,26,27,28,29,30,31]}
    ];
    // No HP untuk pembayaran
    const noHP = "08985152024";
    // Discount page
